...
const string world_file = "../resources/03-tests/world_test.urdf";
const string robot_file = "../resources/03-tests/robot_test.urdf";
const string robot_name = "TEST-ROBOT";
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(windowW, windowH, "SAI2.0 - TEST", NULL, NULL);
