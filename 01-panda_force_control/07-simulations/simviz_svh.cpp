...
const string world_file = "../../resources/01-panda_force_control/world_svh_hand.urdf";
const string robot_file = "../../resources/01-panda_force_control/svh.urdf";
const string robot_name = "SVH-HAND";
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(windowW, windowH, "SAI2.0 - SVH-HAND", NULL, NULL);
