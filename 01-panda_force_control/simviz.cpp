...
const string robot_file = "../resources/01-panda_force_control/panda_arm_sensor.urdf";
...
const Eigen::Vector3d pos_in_link = Eigen::Vector3d(0,0,0.25);
...
void simulation(Sai2Model::Sai2Model* robot, Simulation::Sai2Simulation* sim)
{
	...
	while (runloop) {
		...
		//get Forces from virtual joints
		...
		sim->setJointTorques(robot_name, robot_torques_full);
