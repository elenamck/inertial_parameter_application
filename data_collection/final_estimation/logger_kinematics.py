...
file.write (' pos_des\t pos_curr \t vel_des \t vel_curr \t ori_des \t ori_curr \n')
...
gains =  json.loads(r_server.get(CONTROLLER_GAINS_KEY).decode("utf-8"))


file.write(' pos_des\t pos_curr \t vel_des \t vel_curr \t ori_des \t ori_curr gains:' + str(gains) +"\t")
